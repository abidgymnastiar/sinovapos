...
class StockResource extends Resource
{
    ...
    {
        // Pastikan nilai sold dihitung dan disimpan ke database
        $sold = max(0, $record->opening_stock - $record->closing_stock);
        $record->sold = $sold;
        $record->save(); // Simpan perubahan ke database setelah form disubmit
    }
